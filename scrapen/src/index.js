                    ...
                    return [4 /*yield*/, page.$$eval(selectors.product, function (products, object) {
                            ...
                            return products.map(function (product) {
                                ...
                                if (singleProduct.title === "")
                                    return;
                                var price = product.querySelector(supermarketSelector.prices);
                                var nr;
                                text = price === null || price === void 0 ? void 0 : price.innerText.trim().replace(/ /g, ".").replace("€", "");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(i < index_1["default"].length)) return [3 /*break*/, 4];
                supermarket = index_1["default"][i];
